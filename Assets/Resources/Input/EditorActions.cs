...
//     version 1.13.1
//     from Assets/Resources/Input/EditorActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Resources/Input/EditorActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @EditorActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Main"",
            ""id"": ""451dac5b-da76-4759-80b5-8572193fbf42"",
            ""actions"": [
                {
                    ""name"": ""Record"",
                    ""type"": ""Button"",
                    ""id"": ""cca33f96-a67e-47dc-85b1-8eef62d30642"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""50f40d2e-81e0-4b2a-aa8c-2d5de1cb133e"",
                    ""path"": ""<Keyboard>/OEM5"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Main_Record = m_Main.FindAction("Record", throwIfNotFound: true);
    }

    ~@EditorActions()
    {
        UnityEngine.Debug.Assert(!m_Main.enabled, "This will cause a leak and performance issues, EditorActions.Main.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Main_Record;
    /// <summary>
    ...
    public struct MainActions
    {
        ...
        /// </summary>
        public MainActions(@EditorActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Main/Record".
        /// </summary>
        public InputAction @Record => m_Wrapper.m_Main_Record;
        /// <summary>
