...
public class OSB_MenuButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    public void OnPointerEnter(PointerEventData data)
    {
        ...
        currentTransform.DOSizeDelta(new Vector2(currentTransform.sizeDelta.x * 1.5f, currentTransform.sizeDelta.y), 0.5f).SetEase(Ease.OutExpo);
    ...
    public void OnPointerExit(PointerEventData data)
    {
        ...
        currentTransform.DOKill();
        currentTransform.DOSizeDelta(new Vector2(previousWidth, currentTransform.sizeDelta.y), 0.5f).SetEase(Ease.OutExpo);
        Vector3 pos = currentTransform.position;
        pos.z = 0;
        currentTransform.position = pos;
